            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="appApp.zone.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="appApp.zone.nomVille">Nom Ville</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {zoneList.map((zone, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{zone.nomZone}</td>
                  <td>{zone.nomVille ? <Link to={`/ville/${zone.nomVille.id}`}>{zone.nomVille.id}</Link> : ''}</td>
